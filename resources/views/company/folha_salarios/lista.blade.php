    ...
    <main class="container" style="min-height: 100vh;">
        <section class="page-inner p-3">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <h3 class="fw-bold mb-1">Folhas de Salários</h3>
                    <nav>
                ...
                <div class="card card-body rounded-0 bg-white">
                    ...
                    @else
                        ...
                        <div class="mt-3 d-flex justify-content-between align-items-center mt-0 pt-2 pb-2 p-3 border">
                            {{-- <div>
                                <small>
                                    Exibindo <strong>{{ $folhasSalarios->count() }}</strong> de
                                    <strong>{{ $folhasSalarios->total() }}</strong> registro
                                </small>
                            </div>

                            <div>
                                {{ $folhasSalarios->links('paginacao.pagination') }}
                            </div> --}}
                        </div>
                    {{-- @endif --}}
                </div>
