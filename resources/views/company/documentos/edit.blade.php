...
<div class="modal fade" id="editDocumentoModal{{ $doc->id }}" tabindex="-1"
    aria-labelledby="editDocumentoModalLabel{{ $doc->id }}" aria-hidden="true">
    <div class="modal-dialog modal-ls modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-3">

            <!-- Cabeçalho -->
            <div class="modal-header bg-active text-white">
                <h5 class="modal-title" id="editDocumentoModalLabel{{ $doc->id }}">
            ...
            <!-- Formulário -->
            <form action="{{ route('documento.update', $doc->id) }}" method="POST">
                @csrf
                @method('PUT') @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea name="observacoes" id="observacoes" cols="30" rows="3" class="form-control">{{ $doc->observacoes }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
