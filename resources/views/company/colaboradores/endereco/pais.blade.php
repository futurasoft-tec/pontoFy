<div class="form-group mb-3">
    ...
    <select class="form-select rounded-1 border" id="pais" name="pais">
        ...
        <option value="República Centro-Africana">República Centro-Africana
        </option>
        ...
        <option value="São Vicente e Granadinas">São Vicente e Granadinas
        </option>
